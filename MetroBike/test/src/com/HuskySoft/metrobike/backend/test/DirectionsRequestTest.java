...
public final class DirectionsRequestTest extends TestCase {
    ...
    public void test_toStringTest() {
        ...
        Assert.assertEquals("actual toString for the DirectionRequest object was: " + actual, expected, actual);
    }
    ...
    public void test_doDummyRequest1Test() {
        ...
        Assert.assertEquals("Actual status for request.doRequest() call was: " + actual.getMessage(), expected, actual);
    }
     ...
     * that makes requests to the Google Maps API or else they reject us causing the test
     * to fail.
     */
    //@Test
    ...
    /**
     * WhiteBox: This tests the doDummyRequest with the start address set to null.
     */
    //@Test
    ...
    /**
     * WhiteBox: This tests the doDummyRequest without setting the departure or arrival times for a 
     * transit call.
     */
    //@Test
    ...
    /**
     * WhiteBox: This test should ignore that fact that the departure and arrival times
    ...
    /**
     * WhiteBox: This tests the do dummy Request with the invalid mode of walking.
     */
    //@Test
    ...
    /**
     * WhiteBox: This tests the doDummyRequest method and sets the min greater than the max.
     */
    //@Test
    ...
    /**
     * WhiteBox: This tests the doDummyRequest and sets the value to less than 0.
     */
    //@Test
    ...
    /**
     * WhiteBox: This tests the doDummyRequest and sets the value to less than zero.
    ...
    /**
     * WhiteBox: This tests setting the departure time and then the arrival time.  It 
    ...
    /**
     * WhiteBox: This tests setting the arrival time and then the departure time.  It 
     * should throw an IllegalArgumentException that is caught.
     */
    //@Test
    ...
    public void test_getErrorMessagesTest() {
        ...
        Assert.assertEquals("Actual error messages from request.getErrorMessages() is: " + actual, expected, actual);
    }

    /**
     * WhiteBox: This tests the getSolutions method and checks that the returned list is not null.
     */
    //@Test
    public void test_getSolutionsTest() {
        ...
        Assert.assertFalse("Actual value for actual.equals(null) should have been false.", actual.equals(null));
    }
}
