...
public class TransitRouteTest extends TestCase {
     ...
     */
    private static final int EXPECTED_DURATION_IN_SECONDS_2 = 659;
    
    /**
     * To keep checkstyle happy.
     */
    private static final int EXPECTED_TRANSIT_DURATION_IN_SECONDS_1 = 639;
     ...
     *      If something goes wrong.
     */
    public final void test_getSourceRoute() throws JSONException {
        setUp();
     ...
     *      If something goes wrong.
     */
    public final void test_getDurationInSeconds() throws JSONException {
        setUp();
        long expected = EXPECTED_DURATION_IN_SECONDS_2;
        long actual = transitRoute.getDurationInSeconds();
        Assert.assertEquals(
                "Actual value for transitDetails.getDurationInSeconds() was: " + actual, expected,
                actual);
    }
     ...
     *      If something goes wrong.
     */
    public final void test_getTransitDurationInSeconds() throws JSONException {
        setUp();
        long expected = EXPECTED_TRANSIT_DURATION_IN_SECONDS_1;
        long actual = transitRoute.getTransitDurationInSeconds();
        Assert.assertEquals("Actual value for transitDetails.getTransitDurationInSeconds() was: "
