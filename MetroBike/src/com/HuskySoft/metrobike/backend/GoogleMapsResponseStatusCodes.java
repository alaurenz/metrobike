 ...
 * @author coreyh3
 * 
 *         Values that the "status" field in the JSON response can take on. I'm
 *         not sure if we need this but I thought it might be nice to have.
 * 
 */
public enum GoogleMapsResponseStatusCodes {
     ...
     * Google Maps API for Business customers may contain requests with up to 23
     * waypoints.)
     */
